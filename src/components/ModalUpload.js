...
import { Backdrop, Button, CircularProgress, Fade, FormControl, IconButton, Input, InputLabel, MenuItem, Modal, Select, TextareaAutosize, TextField, Typography } from '@mui/material'
...
const ModalUpload = ({ onFile, onFileAvatar,formik,preview,type,percent,loadingUpload}) => {
    const style = {
        position: "absolute",
        top: "50%",
        left: "50%",
