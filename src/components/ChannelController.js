...
const ChannelController = () => {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-between items-center px-5 py-4 sm:px-24 ">
        <div className="flex items-center">
          ...
          <div className="px-5">
            ...
            <p className="text-gray-600 text-md">{user?.follows.length || 0} người đăng ký</p>
          </div>
        </div>
       <div className="flex items-center"> 
